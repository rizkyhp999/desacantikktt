...
import PublikasiClient from "./client/PublikasiClient";

/**
 * Halaman Publikasi & Dokumen Resmi Desa Cantik (Descan) Buong Baru 2026
 * Server Component yang memuat katalog publikasi dan dokumen PDF desa
 */
